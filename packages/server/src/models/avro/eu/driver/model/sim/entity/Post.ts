...
import { MediumTypes } from "./MediumTypesEnum";
...
export class Post extends BaseAvroRecord implements PostInterface {
    ...
    "fields": [
        ...
        },
        {
            ...
            "doc": "The fictive creation date and time of this post as the number of milliseconds from the unix epoch, 1 January 1970 00:00:00.000 UTC."
        },
        {
            "name": "location",
    ...
    public static deserialize(buffer: Buffer, newSchema?: object): Post {
    ...
    public name!: string;
    public owner!: string;
    public mediumType!: MediumTypes;
    public mediumName!: string;
    public header?: null | string = null;
    public intro?: null | string = null;
    public body!: string;
    public files?: null | string[] = null;
    public visibleForParticipant!: boolean;
    public senderName!: string;
    public senderRole?: null | string = null;
    public recipients?: null | string[] = null;
    public date!: number;
