...
import { ScenarioLabel } from "./ScenarioLabelEnum";
...
export class Station extends BaseAvroRecord implements StationInterface {
    ...
    public static deserialize(buffer: Buffer, newSchema?: object): Station {
    ...
    public scenarioLabel?: null | ScenarioLabel = null;
